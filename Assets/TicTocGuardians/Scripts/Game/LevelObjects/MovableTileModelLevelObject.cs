...
namespace TicTocGuardians.Scripts.Game.LevelObjects
{
            ...
            foreach (var x in objects)
            {
                ...
                for (var i = 0; i < points.Length; i++)
                {
                    ...
                    var matrix = transform.localToWorldMatrix *
                                 Matrix4x4.TRS(x.transform.localPosition, x.transform.localRotation,
                                     x.transform.localScale) * Matrix4x4.Translate(points[i].localPosition);
        ...
        public void NextPoint()
        {
            switch (playback)
            {
                ...
                case Playback.Returning:
                    if (nextPointIndex < points.Length - 1) nextPointIndex++;
                    break;
                default:
    ...
    public class MovableTileLevelObjectEditor : Editor
    {
        ...
        {
            var obj = (MovableTileModelLevelObject)target;
